<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostBack="true" CodeBehind="WebForm1.aspx.cs" Inherits="QRgenerate.WebForm1" %>
        ...
        <div style="margin-left:30px;">
            <asp:GridView GridLines="None" CssClass="table table-condensed table-responsive table-hover" 
                ...
                <Columns>                    
                    ...
                    <asp:BoundField DataField="E_Mail" HeaderText="<center>Correo</center>" SortExpression="E_Mail" HtmlEncode="false" ReadOnly="false" /> 
                    ...
                    <asp:TemplateField HeaderText="<center>PDF</center>">
                        <ItemTemplate>
                            <asp:Button ID="btnPDF" runat="server" Text="Descargar PDF" CommandName="GenerarPDF" 
                                CommandArgument='<%# Eval("id_lugar_reserva") + "|" + Eval("lugar") 
                                    + "|" + Eval("codigo_con") + "|" + Eval("nombre_reserva") + "|" + Eval("codigo_reserva") + "|" + Eval("E_Mail") %>'/>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div style="margin-left:30px">
                    <h1>Lectura QR</h1>
                    <br />
                    <asp:CheckBox ID="chkCoffee" runat="server" text="Coffee Breake"/>
                    <br />
                    <br />     
                    <asp:TextBox ID="txtCodigo" runat="server" AutoPostBack="true" OnTextChanged="txtCodigo_TextChanged" placeholder="Ingrese Codigo"></asp:TextBox>
                    <asp:Label ID="lblValidaIngreso" runat="server" Text=""></asp:Label><br />
                    <br />
                    <asp:Label ID="lblCodigoCompro" runat="server" Text="Codigo Compra" Enabled="false"></asp:Label><br />
                    <asp:TextBox ID="txtCodigoCompro" runat="server" Enabled="false"></asp:TextBox><br />
                    <asp:TextBox ID="txtNombreCompro" runat="server" Width="350px" Enabled="false"></asp:TextBox><br />
                    <asp:TextBox ID="txtUnidad" runat="server" Width="350px" Enabled="false"></asp:TextBox>
                    <br />
                    <br />
                    <br />
                    <asp:Label ID="Label1" runat="server" Text="Codigo Reservado"></asp:Label><br />
                    <asp:TextBox ID="txtCodigoReservado" runat="server" Enabled="false"></asp:TextBox><br />
                    <asp:TextBox ID="txtLugar" runat="server" Enabled="false"></asp:TextBox><br />
                    <asp:TextBox ID="txtNombrereservado" runat="server" Width="350px" Enabled="false"></asp:TextBox><br />        
                    <br />
                    <br />
                    <br />
                </div>
